...
import { Home, Mail, FileDown } from "lucide-react";
    ...
    <main className="relative mx-auto min-h-screen max-w-2xl px-6 py-12 sm:py-24">
      ...
      <div className="flex flex-col gap-12">
        ...
        <section id="about">
          ...
          <BlurFade delay={BLUR_DELAY * 4}>
            <p className="prose max-w-full text-pretty font-sans text-sm text-neutral-600 dark:text-neutral-400">
              {about.lead} {about.body[0]}
            </p>
          </BlurFade>
        </section>
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-4 flex origin-bottom h-full max-h-14">
        <div className="pointer-events-auto mx-auto w-full">
          <Dock>
            <DockIcon href="/" label="Naar de huidige site">
              <Home size={18} />
            </DockIcon>
      ...
      <div className="pb-16 text-center">
        ...
        >
          Dit is een voorbeeldweergave. Terug naar de huidige site.
        </Link>
      </div>
    </main>
  );
